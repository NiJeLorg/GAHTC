...
def membersView(request):
	...
	contributing_profiles_returned = profile.objects.filter(verified=True, public=True).exclude(last_name='', first_name='').exclude(modules=None).exclude(lectures=None).exclude(comingsoonmodules=None).order_by('last_name', 'first_name')

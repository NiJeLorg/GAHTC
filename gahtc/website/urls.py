...
urlpatterns = [
    ...
    url(r'^show_lecture_description/(?P<id>\d+)/$', views.showLectureDescription, name='showLectureDescription'),
    ...
    url(r'^browse/$', views.modulesView, name='modulesView'),
    url(r'^index/$', views.indexView, name='indexView'),
    url(r'^lecture/(?P<id>\d+)/$', views.lectureView, name='lectureView'),
    url(r'^lecture_comments/(?P<id>\d+)/$', views.lectureComments, name='lectureComments'),
    url(r'^module_comments/(?P<id>\d+)/$', views.moduleComments, name='moduleComments'),
